...
namespace Ecommerce.Infrastructure.Database
{
    public class EcommerceContext(DbContextOptions<EcommerceContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // modelBuilder.HasDbFunction(typeof(EcommerceContext).GetMethod(nameof(GetDiscounts), [typeof(int?), typeof(int?)])!).HasName("get_all_discounts");
            // modelBuilder.HasDbFunction(typeof(EcommerceContext).GetMethod(nameof(UpsertDiscount), [typeof(string), typeof(string), typeof(decimal), typeof(int), typeof(int), typeof(int?)])!).HasName("upsert_discount");
            // modelBuilder.HasDbFunction(typeof(EcommerceContext).GetMethod(nameof(GetDiscountById), [typeof(int)])!).HasName("get_discount_by_id");
            // modelBuilder.HasDbFunction(typeof(EcommerceContext).GetMethod(nameof(PatchDiscount), [typeof(int), typeof(string), typeof(string), typeof(decimal?), typeof(int?), typeof(int?)])!).HasName("patch_discount");
        ...
        public IQueryable<Discount> GetDiscountById(int discountId)
        {
            // return FromExpression(() => GetDiscountById(discountId));
            return null;

        }
        // public IQueryable<Discount> GetDiscounts(int? page, int? pageSize) => FromExpression(() => GetDiscounts(page, pageSize));
        public IQueryable<Discount> GetDiscounts(int? page, int? pageSize) 
        {

        return null;
        }
        public IQueryable<Discount> UpsertDiscount(string title, string description, string type, int percent, string code, int? discountId = null)
        {
            // return FromExpression(() => UpsertDiscount(title, description, type, percent, code, discountId));
            return null;
        }
        public IQueryable<Discount> PatchDiscount(int discountId, string? title = null, string? description = null, string? type = null, int? percent = null, string? code = null)
        {
            // return FromExpression(() => PatchDiscount(discountId, title, description, type, percent, code));
            return null;
        }
